    ...
    <Box component="form" onSubmit={handleSubmit} sx={{ maxWidth: '800px', margin: '40px auto', padding: '32px', backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} container spacing={3}>
            ...
            <Grid item xs={12} sm={4}>
                <TextField name="valor_total" label="Valor Total" type="number" value={formData.valor_total} onChange={handleFormChange} InputProps={{ inputProps: { step: "0.01" } }} placeholder="0.00" required fullWidth/>
            </Grid>
        </Grid>
        <Grid item xs={12}>
